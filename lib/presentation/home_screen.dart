                          ...
                          children: [
                            Stack(
                              ...
                              children: [
                                 LinearProgressIndicator(
                                  ...
                                  value: prgressbarValue(currectAnsersList.length),
                                  color:const Color(0xFFC353D6),
                                  backgroundColor:const Color(0xFF6C2677),
                                ),
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 20),
                                  child: CustomTextWidget(textValue: currectAnsersList.length.toString(),
                           ...
                           ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                             ...
                             return fHight20;
                           }, itemCount: state.quizList[state.index].options.length),
                           fHight30,
                            Visibility(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    child: CustomTextWidget(textValue: "Next",textSize: 18),
                                  ),
                                ],
                              ),
                            ),
